...
#             ["PNG", "JPEG", "SVG", "HTML"],
#             horizontal=True,
#             key="export_interactive_charts"  # Unique key for export options to avoid conflicts
#         )
        
#         # Export button
#         if st.button("Export Chart",key="export_interactive_charts1", use_container_width=True):
...
#             horizontal=True,
#             key="interactive_plot_3d_type"  # Unique key for 3D plot type to avoid conflicts
#         )
...
#             ["Scatter", "Bar", "Line"],
#             horizontal=True,
#             key="interactive_plot_anim_type"  # Unique key for animation type to avoid conflicts
#         )
...
#             ["HTML", "PNG", "JPEG", "SVG"],
#             horizontal=True,
#             key="export_interactive_chart_main"  # Unique key for export options to avoid conflicts
#         )
        
#         # Export button
#         if st.button("Export Chart",key="export_interactive_chart_main1", use_container_width=True):
#             if export_format == "HTML":
#                 # Export as HTML file
#                 buffer = StringIO()
#                 fig.write_html(buffer)
...
#             horizontal=True,
#             key="correlation_method"  # Unique key for correlation method to avoid conflicts
#         )
...
#             ["HTML", "PNG", "JPEG", "SVG"],
#             horizontal=True,
#             key="export_interactive_geospatial_plots"  # Unique key for export options to avoid conflicts
#         )
...
#                 horizontal=True,
#                 key="funnel_sort_order"  # Unique key for sort order to avoid conflicts
#             )
...
#             ["HTML", "PNG", "JPEG", "SVG"],
#             horizontal=True,
#             key="export_interactive_custom_viz"  # Unique key for export options to avoid conflicts
#         )
